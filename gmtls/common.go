...
func convertToPublicKey(pubKey interface{}) (*ecdsa.PublicKey, error) {
	...
	case *sm2.PublicKey:
		return &ecdsa.PublicKey{
			Curve: sm2.P256Sm2(),
			X:     pubKey.(*sm2.PublicKey).X,
			Y:     pubKey.(*sm2.PublicKey).Y,
		}, nil
	default:
		return nil, errors.New("gmtls: unsupported public key type")
	}
}
